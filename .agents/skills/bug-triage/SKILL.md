...
```bash
gh issue list --repo AronPerez/agent-orchestrator --state all --search '<symptom or error>'
gh pr list --repo AronPerez/agent-orchestrator --state all --search '<symptom or error>'
```
