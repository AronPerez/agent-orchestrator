...
export function applyPairingPayload(
  cfg: ServerConfig,
  ...
  return {
    ...
    // A QR has no display name; never carry the active node's label onto a
    // different machine. saveConfig keeps an existing match or falls back to host.
    label: "",
