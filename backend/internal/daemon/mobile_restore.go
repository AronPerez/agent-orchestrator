...
// — the paired phone keeps working), derives the auth hash in memory, restores
// its configured bind interface and last bound port, and — critically — re-applies the
