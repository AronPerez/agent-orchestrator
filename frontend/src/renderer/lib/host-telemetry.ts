...
// "why isn't my remote updating?". These three signals cover the three ways
// that goes wrong — the host never connects, its stream stops, or its data
// stops loading.
//
...
// the same (host, status), same guard api-client already runs over api_error.
