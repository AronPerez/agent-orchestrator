...
Do not set `HOST=0.0.0.0` or proxy the primary daemon to a network. For phone access, use the separate authenticated listener created by **Connect Mobile**. See [Remote access](/docs/configuration/remote-access), and [Remote sessions](/docs/configuration/remote-sessions) for connecting the desktop app to another machine over the same listener.
...
<Cards>
	...
	<Card title="Remote sessions" href="/docs/configuration/remote-sessions" description="Work with another machine's daemon over a trusted network." />
</Cards>
